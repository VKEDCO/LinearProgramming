/*
 * Tableau Class for the Simplex Method
...
public class Tableau {
    ...
    public Tableau(String[] colVars, String[] rowVars, Ratio[][] matrix) {
        mColVars = colVars;
        mRowVars = rowVars;
        mMatrix = matrix;
    }
    ...
    // test a few tableus.
    public int findDepartVar(int enter_var_index) {
        Ratio smallest = null;
        int row_index = -1;
    ...
    public void doPivoting(int pivot_row, int pivot_col) {
    ...
    public static void doSimplex(Tableau tableau) {
        Tableau.SOLUTION sol = tableau.simplex();
        System.out.println(sol);
        if (sol == Tableau.SOLUTION.YES) {
            tableau.display();
        }
    }
}
